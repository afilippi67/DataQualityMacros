...
void plotResidualsVSPos(const char* fname){
  ...
  TCanvas *cTop = new TCanvas("cTop","Residuals u vs u in lab frame, TOP", 800, 1200);
  TCanvas *cBot = new TCanvas("cBot","Residuals u vs u in lab frame, BOTTOM",800, 1200);
  ...
  TString outname ="residualsVSUhit"; outname += outn.Data(); outname += "_scat.txt";
  TString topName ="residualsVSUhit"; topName += outn.Data(); topName += "_scat_top.pdf";
  TString botName ="residualsVSUhit"; botName += outn.Data(); botName += "_scat_bot.pdf";
