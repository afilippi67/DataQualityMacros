...
void plotResidualsVSPos_new(char* fname){
  ...
  TString outname ="residuals_"; outname += outn.Data(); outname += "_scatter.txt";
  TString topName ="residuals_"; topName += outn.Data(); topName += "_scatter_topO.gif";
  TString botName ="residuals_"; botName += outn.Data(); botName += "_scatter_botO.gif";
