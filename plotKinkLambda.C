...
void plotKinkLambda(const char* fname){
  ...
  TString topName ="lambdaKink_"; topName += outn.Data(); topName += "_top.pdf";
  TString botName ="lambdaKink_"; botName += outn.Data(); botName += "_bot.pdf";
...
//    his->GetXaxis()->SetRangeUser(lo,hi);
  ...
  TString mean = "lambdaKink_"; mean += outn.Data(); mean += "_TopBot_ini.pdf";
