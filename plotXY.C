...
void plotXY(const char* fname){
  ...
  TCanvas *cTop = new TCanvas("cTop","Hit position v vs u in sensor frame, TOP", 800, 1200);
  TCanvas *cBot = new TCanvas("cBot","Hit position v vs u in sensor frame, BOTTOM",800, 1200);
  ...
  Int_t ipad=0;
  for(Int_t i=1; i<5; i++){
    TString hisname = "hit_u_vs_v_sensor_frame_module_L"; hisname += i;
    ...
    TString hisnameIni = "hit_u_vs_v_sensor_frame_module_L"; hisnameIni += i;
    ...
    hisname = "hit_u_vs_v_sensor_frame_module_L"; hisname += i;
    ...
    hisnameIni = "hit_u_vs_v_sensor_frame_module_L"; hisnameIni += i;
