...
void plotResidualsUVSPosV_new(char* fname){
  ...
  TString outname ="residualsUvsV_"; outname += outn.Data(); outname += "_scatter.txt";
  TString topName ="residualsUvsV_"; topName += outn.Data(); topName += "_scatter_topO.gif";
  TString botName ="residualsUvsV_"; botName += outn.Data(); botName += "_scatter_botO.gif";
