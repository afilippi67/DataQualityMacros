...
void plotSingleSensor(const Char_t *sensor, const Char_t *file){
  ...
  if(is<5){
    ...
    nam5T = "hit_u_vs_v_sensor_frame_module_L"          ; nam5T+=is; nam5T += "t_halfmodule_axial_sensor0";
    nam5B = "hit_u_vs_v_sensor_frame_module_L"          ; nam5B+=is; nam5B += "b_halfmodule_axial_sensor0";
    nam6T = "predicted_u_vs_v_sensor_frame_module_L"    ; nam6T+=is; nam6T += "t_halfmodule_axial_sensor0";
    nam6B = "predicted_u_vs_v_sensor_frame_module_L"    ; nam6B+=is; nam6B += "b_halfmodule_axial_sensor0";
    ...
    nam5TS = "hit_u_vs_v_sensor_frame_module_L"          ; nam5TS+=is; nam5TS += "t_halfmodule_stereo_sensor0";
    nam5BS = "hit_u_vs_v_sensor_frame_module_L"          ; nam5BS+=is; nam5BS += "b_halfmodule_stereo_sensor0";
    nam6TS = "predicted_u_vs_v_sensor_frame_module_L"    ; nam6TS+=is; nam6TS += "t_halfmodule_stereo_sensor0";
    nam6BS = "predicted_u_vs_v_sensor_frame_module_L"    ; nam6BS+=is; nam6BS += "b_halfmodule_stereo_sensor0";
    ...
    if(sensName.Contains("H")){
      ...
      nam5T = "hit_u_vs_v_sensor_frame_module_L"          ; nam5T+=is; nam5T += "t_halfmodule_axial_hole_sensor0";
      nam5B = "hit_u_vs_v_sensor_frame_module_L"          ; nam5B+=is; nam5B += "b_halfmodule_axial_hole_sensor0";
      nam6T = "predicted_u_vs_v_sensor_frame_module_L"    ; nam6T+=is; nam6T += "t_halfmodule_axial_hole_sensor0";
      nam6B = "predicted_u_vs_v_sensor_frame_module_L"    ; nam6B+=is; nam6B += "b_halfmodule_axial_hole_sensor0";
      ...
      nam5TS = "hit_u_vs_v_sensor_frame_module_L"          ; nam5TS+=is; nam5TS += "t_halfmodule_stereo_hole_sensor0";
      nam5BS = "hit_u_vs_v_sensor_frame_module_L"          ; nam5BS+=is; nam5BS += "b_halfmodule_stereo_hole_sensor0";
      nam6TS = "predicted_u_vs_v_sensor_frame_module_L"    ; nam6TS+=is; nam6TS += "t_halfmodule_stereo_hole_sensor0";
      nam6BS = "predicted_u_vs_v_sensor_frame_module_L"    ; nam6BS+=is; nam6BS += "b_halfmodule_stereo_hole_sensor0";
      ...
      nam5T = "hit_u_vs_v_sensor_frame_module_L"          ; nam5T+=is; nam5T += "t_halfmodule_axial_slot_sensor0";
      nam5B = "hit_u_vs_v_sensor_frame_module_L"          ; nam5B+=is; nam5B += "b_halfmodule_axial_slot_sensor0";
      nam6T = "predicted_u_vs_v_sensor_frame_module_L"    ; nam6T+=is; nam6T += "t_halfmodule_axial_slot_sensor0";
      nam6B = "predicted_u_vs_v_sensor_frame_module_L"    ; nam6B+=is; nam6B += "b_halfmodule_axial_slot_sensor0";
      ...
      nam5TS = "hit_u_vs_v_sensor_frame_module_L"          ; nam5TS+=is; nam5TS += "t_halfmodule_stereo_slot_sensor0";
      nam5BS = "hit_u_vs_v_sensor_frame_module_L"          ; nam5BS+=is; nam5BS += "b_halfmodule_stereo_slot_sensor0";
      nam6TS = "predicted_u_vs_v_sensor_frame_module_L"    ; nam6TS+=is; nam6TS += "t_halfmodule_stereo_slot_sensor0";
      nam6BS = "predicted_u_vs_v_sensor_frame_module_L"    ; nam6BS+=is; nam6BS += "b_halfmodule_stereo_slot_sensor0";
  ...
  title = "GBL residual vs u hit xensor "; title += sensName.Data(); title += " stereo top";
  ...
  title = "hit u vs v position sensor "; title += sensName.Data(); title += " axial top";
  his5->SetTitle(title.Data());
  title = "hit u vs v position sensor "; title += sensName.Data(); title += " stereo top";
  ...
  title = "hit u vs v position sensor "; title += sensName.Data(); title += " axial bottom";
  his5b->SetTitle(title.Data());
  title = "hit u vs v position sensor "; title += sensName.Data(); title += " stereo bottom";
