...
void plotXY_neg(Char_t* fname){
  ...
  // plots y vs x in the sensor RF for negative tracks only
  ...
  TString outname ="predXY_NEG_"; outname += outn.Data(); outname += ".txt";
  TString topName ="predXY_NEG_"; topName += outn.Data(); topName += "_topO.gif";
  TString botName ="predXY_NEG_"; botName += outn.Data(); botName += "_botO.gif";
